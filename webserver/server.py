...
def landing():
    ...
    for result in cursor:
        ...
        f_name_rate.append(result['name']+' '+str(100*result['liked'])+"%")
    ...
    for result in cursor:
        ...
        c_name_rate.append(result['name']+' '+str(result['rate'])+"/5.0")

    context = dict(is_foodie = isFoodie,uname=session.get('username'), topFoodie = zip(f_rid,f_name_rate), topCritic = zip(c_rid, c_name_rate))
